        ...
        if(isValidTreasure()){
            ...
            ApiController.getInstance().createdTreasureClaim(treasureClaim, new Callback<String>() {
                ...
                public void onFailure(Call<String> call, Throwable t) {
                    Util.makeSnackbar( mView, getString(R.string.Claim_SnackBarError2), Snackbar.LENGTH_SHORT, R.color.orange900);
                }});
        }else{
            Util.makeSnackbar( mView, getString(R.string.Claim_snackBarError1), Snackbar.LENGTH_LONG, R.color.orange900);
        }
    }
