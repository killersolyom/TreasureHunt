package com.threess.summership.treasurehunt.camera;
...
public class DrawableImageView extends android.support.v7.widget.AppCompatImageView
{
    ...
    private static final String TAG = "drawable_image_view";
    ...
    private void dragStickerStarted(){
        if(mHostActivity != null){
            if(mHostActivity instanceof CameraActivity){
                ((CameraActivity)mHostActivity).dragStickerStarted();
            }
        }
    }
    ...
    private void dragStickerStopped(){
        if(mHostActivity != null){
            if(mHostActivity instanceof CameraActivity){
                ((CameraActivity)mHostActivity).dragStickerStopped();
            }
        }
        removeCircle();
    }
    ...
    public void enlargeTrashIcon(){
        if(mHostActivity instanceof CameraActivity){
            ((CameraActivity)mHostActivity).setTrashIconSize(TRASH_ICON_ENLARGED_SIZE, TRASH_ICON_ENLARGED_SIZE);
        }
    }

    public void shrinkTrashIcon(){
        if(mHostActivity instanceof CameraActivity){
            ((CameraActivity)mHostActivity).setTrashIconSize(TRASH_ICON_NORMAL_SIZE, TRASH_ICON_NORMAL_SIZE);
        }
    }
    ...
    private void drawingStarted(){
        if(mHostActivity != null){
            if(mHostActivity instanceof CameraActivity){
                ((CameraActivity)mHostActivity).hideStillshotWidgets();
            }
        }
    }
    ...
    private void drawingStopped(){
        if(mHostActivity != null){
            if(mHostActivity instanceof CameraActivity){
                ((CameraActivity)mHostActivity).showStillshotWidgets();
            }
        }
        removeCircle();
    }
